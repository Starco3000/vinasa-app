...
function Nominations() {
  return (
    <div>
      <SubBanner title="Danh sách giải thưởng đề cử 2023" />
      <div className="nominations font-open-sans">
        <h1 className="nominations-title text-3xl leading-snug tracking-tight">
          Danh sách giải thưởng đề cử 2023
        </h1>
        <table className="awards-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                Sử dụng vỏ trấu và nilong để chế tạo ra vật liệu xây dựng ( gạch
                lát đường) bảo vệ môi trường
              </td>
            ...
            <tr>
              ...
              <td>
                Ứng dụng công nghệ 3D Animation để tăng khả năng tiếp cận lịch
                sử của học sinh trong thời kỳ đổi mới
              </td>
            ...
            <tr>
              ...
              <td>
                Ứng dụng vòng tròn xanh - ứng dụng khuyến khích học tập sáng tạo
                và mua bán các sản phẩm tái chế. (Tên hiển trị trên web: App
                Green Circle - ứng dụng khuyến khích học tập sáng tạo và mua bán
            ...
            <tr>
              ...
              <td>
                Mentasoothe - Giải pháp chăm sóc sức khỏe tâm thần cùng trợ lý
                ảo sử dụng trí tuệ nhân tạo
              </td>
            ...
            <tr>
              ...
              <td>
                DoctorSkin - Ứng dụng hỗ trợ chẩn đoán bệnh da liễu phổ biến cho
                người Việt
              </td>
            ...
            <tr>
              ...
              <td>
                Phát triển bộ công cụ DaNangNLP để tiền xử lý và trích xuất
                thông tin trong xử lý ngôn ngữ Tiếng Việt
              </td>
            ...
            <tr>
              ...
              <td>
                Máy đo huyết áp, oxi máu thông minh - ứng dụng trí tuệ nhân tạo
                và IoT giúp hỗ trợ theo dõi và chẩn đoán một số bệnh lý tim mạch
              </td>
              <td>Y tế và chăm sóc sức khỏe</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>Khoa Kỹ thuật và Công nghệ - Đại học Huế</td>
              <td>
                Ứng dụng xử lý ảnh và mã QR code phục vụ phân loại sản phẩm trên
                mô hình MPS 2000
              </td>
              <td>Trí tuệ nhân tạo và tự động hóa</td>
            </tr>
